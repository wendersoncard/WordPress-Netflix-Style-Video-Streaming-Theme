...
<div class="video-main">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    	...
    	<?php 
    		...
    		<?php if(isset($_GET['trailer'])) : ?>

				<?php if ( ! empty( $streamiumVideoTrailer ) ) : ?>
					
					<script type="text/javascript">S3BubbleAWS.init({id : "s3bubble-aws",code : "<?php echo $streamiumVideoTrailer; ?>"});</script>
		...
		<?php else : ?>
			...
			<?php if(isset($_GET['trailer'])) : ?>
				...
				<?php if ( ! empty( $streamiumVideoTrailer ) && filter_var($streamiumVideoTrailer, FILTER_VALIDATE_URL) ) : ?>
					
					<div style="position: relative;padding-bottom: 56.25%;"><iframe style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;" src="<?php echo $streamiumVideoTrailer; ?>" frameborder="0" allowfullscreen="allowfullscreen"></iframe></div>
